...
```text
crimson/assets/music/
```

For example:

```text
crimson/assets/music/intro.ogg
crimson/assets/music/crimson_theme.ogg
crimson/assets/music/gt1_ingame.ogg
crimson/assets/music/gt2_harppen.ogg
```
